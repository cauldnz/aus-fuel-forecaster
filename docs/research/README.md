...
| File | Topic | Spec ref |
|---|---|---|
| [`2026-05_major_events_features.md`](2026-05_major_events_features.md) | Spatial event features (AFL/NRL fixtures, major venues, long weekends). Gated on a Phase 0 EDA check. | spec §13.6 |
